...
export function VolumeIcon({ className = "w-6 h-6" }: IconProps) {
  return (
    <svg
      className={className}
      fill="currentColor"
...
export function VolumeMuteIcon({ className = "w-6 h-6" }: IconProps) {
  return (
    <svg
      className={className}
      fill="currentColor"
...
export function FullscreenIcon({ className = "w-6 h-6" }: IconProps) {
  return (
    <svg
      className={className}
      fill="currentColor"
